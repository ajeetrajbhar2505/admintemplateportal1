$(function () {
	...
	var chart = new ApexCharts(document.querySelector("#data-chart9"), options);
	chart.render();
	// chart 10
	var options = {
		chart: {
	...
	var chart = new ApexCharts(document.querySelector("#data-chart10"), options);
	chart.render();
	// chart 11 
	var options = {
		chart: {
	...
	var chart = new ApexCharts(document.querySelector("#data-chart11"), options);
	chart.render();
	...
	var chart = new ApexCharts(document.querySelector("#data-chart-24"), options);
	chart.render();
	// window.setInterval(function () {
	//     chart.updateSeries([Math.floor(Math.random() * (100 - 1 + 1)) + 1])
	// }, 2000)
	...
	var chart = new ApexCharts(document.querySelector("#data-chart-25"), options);
	chart.render();
	// window.setInterval(function () {
	//     chart.updateSeries([Math.floor(Math.random() * (100 - 1 + 1)) + 1])
	// }, 2000)
	...
	var chart = new ApexCharts(document.querySelector("#data-chart-26"), options);
	chart.render();
	// window.setInterval(function () {
	//     chart.updateSeries([Math.floor(Math.random() * (100 - 1 + 1)) + 1])
	// }, 2000)
	...
	var chart = new ApexCharts(document.querySelector("#data-chart-27"), options);
	chart.render();
	// window.setInterval(function () {
	//     chart.updateSeries([Math.floor(Math.random() * (100 - 1 + 1)) + 1])
	// }, 2000)
