$(function () {
	...
	var chart = new ApexCharts(document.querySelector("#vacancy-status"), options);
	chart.render();
	// chart 7
	var options = {
		chart: {
	...
	var chart = new ApexCharts(document.querySelector("#top-refefrers"), options);
	chart.render();
	// chart 8
	var options1 = {
		chart: {
	...
	var options = {
		...
		fill: {
			...
			gradient: {
				shade: 'light',
				gradientToColors: ['#00c8ff', '#e100ff'],
				shadeIntensity: 1,
				type: 'vertical',
				opacityFrom: 1,
				opacityTo: 1,
